  ...
  return <Card className="overflow-hidden">
      ...
      <CardFooter className="bg-primary position-relative mt-3">
        <div className="position-absolute top-0 start-0 translate-middle-y ms-3">
          {user?.image && <img src={user?.image} alt="avatar" width={72} height={72} className="avatar-lg border border-light border-3 rounded-circle" />}
        </div>
        <div className="position-absolute top-0 end-0 translate-middle-y me-3">
          <img src={doubleImg} width={56} height={56} alt="double" className="avatar-md" />
        </div>
        <div className="mt-4">
