              ...
              <div className="mb-4">
                ...
                <div className="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                  <div>
                    ...
                    {item.isInvoice && <Link to="" className="btn btn-light">
                        Resend Invoice
                      </Link>}
                    {item.downloadInvoice && <Link to="" className="btn btn-primary">
                        Download Invoice
                      </Link>}
                    ...
                    {item.orderButton && item.orderButton.map((item, idx) => <Fragment key={idx}>
                          <Link to="" key={idx} className="badge bg-light text-dark fw-normal  px-2 py-1 fs-13">
                            {item}
                          </Link>{' '}
                          &nbsp;
                        </Fragment>)}
