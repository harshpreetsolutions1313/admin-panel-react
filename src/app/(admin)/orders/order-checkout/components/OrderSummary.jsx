...
const OrderSummary = () => {
  ...
  return <>
      <Card>
        ...
        <CardBody>
          <div className="table-responsive">
            {productData?.slice(0, 4).map((item, idx) => <div className="d-flex align-items-center gap-3 mb-4" key={idx}>
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  {item.product?.image && <img src={item.product.image} alt="product" className="avatar" />}
                </div>
                <div>
      ...
      <div className="main-btn my-4 text-end">
        <Link to="/orders/order-cart" className="btn btn-danger">
          Back To Cart
        </Link>
        &nbsp;
        <Link to="#!" onClick={toggle} className="btn btn-success" data-bs-toggle="modal" data-bs-target="#checkoutModal">
          Checkout Order
        </Link>
      </div>
                ...
                <Row className="align-items-center">
                  <Col lg={12}>
                    <div className="check-icon text-center">
                      <img src={partyImage} alt="party" className="img-fluid" />
                    ...
                    <div className="row justify-content-between mt-3 align-items-center">
                      ...
                      <Col lg={4} xs={6} className="text-end">
                        <img src={avatar1} alt="avatar-1" className="avatar rounded-circle" />
                      </Col>
                    </div>
                    <div className="row justify-content-between mt-3 align-items-center">
                      <Col lg={6} xs={6}>
            ...
            <div data-bs-theme="dark">
              <CardFooter className="d-flex align-items-center border-0 bg-body gap-3 rounded">
                <div className="rounded-3 avatar bg-light d-flex align-items-center justify-content-center">
                  <img src={mastercardImg} alt="mastercard-Img" className="avatar-sm" />
                </div>
                ...
                <div className="ms-auto">
                  <OverlayTrigger placement="bottom" overlay={<Tooltip id="tooltip">Download Invoice</Tooltip>}>
                    <Link to="#!" className="text-primary fs-30" data-bs-toggle="tooltip" data-bs-title="Download Invoice" data-bs-placement="bottom">
