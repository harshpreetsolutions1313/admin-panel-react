                        ...
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <img src={BrandDhlImg} alt="BrandDhlImg" className="avatar rounded" />
                            </div>
                            <div>
                    ...
                    <div className="form-check form-checkbox-primary ps-0">
                      <label htmlFor="shipping-2" className="w-100">
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <img src={fedex} alt="fedex" className="avatar rounded" />
                            </div>
                            <div>
                    ...
                    <div className="form-check form-checkbox-primary ps-0">
                      <label htmlFor="shipping-3" className="w-100">
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <img src={brandUpsImg} alt="brandUpsImg" className="avatar rounded" />
                            </div>
                            <div>
                  ...
                  <Accordion defaultActiveKey="1" id="accordionExample">
                          ...
                          <AccordionHeader className="mb-0">
                            <div className="rounded-0 rounded-top-1">
                              <div className="d-flex align-items-center justify-content-between">
                                ...
                                <img src={paypalImg} alt="paypalImg" className="avatar-sm" />
                              </div>
                            </div>
                          </AccordionHeader>
                    ...
                    <Card className="mb-0">
                      <CardHeader className="p-0">
                        <h2 className="mb-0">
                          <button className="btn btn-light w-100 collapsed rounded-0 border-bottom rounded-top-1" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <div className="d-flex align-items-center justify-content-between">
                              <span className="fs-5">Credit card</span>
                              <div className="icons text-end">
                                <img src={mastercardImg} alt="mastercard" className="avatar-sm" />
                                <img src={stripeImg} alt="stripeCard" className="avatar-sm" />
                                <img src={visaCardImg} alt="visaCardImg" className="avatar-sm" />
                              </div>
                            </div>
                          </button>
                        </h2>
                        ...
                        <div className="p-3">
                          <form>
                            <div className="mb-3">
                              ...
                              <input type="number" id="card-number" name="card-number" className="form-control" placeholder="0000 0000 0000 0000" max={16} maxLength={16} required />
                            </div>
                          </form>
                          <Row>
                            <Col md={6}>
                            ...
                            <Col md={6}>
                              <div className="mb-3">
                                ...
                                <input type="number" id="card-cvv" name="card-cvv" className="form-control" placeholder={'000'} min={0} max={3} maxLength={3} required />
                              </div>
                            </Col>
                          </Row>
...
const PromoCard = () => {
  return <Card className="text-center bg-primary overflow-hidden z-1">
        ...
        <div className="position-relative mt-3">
          <div className="form-button">
            <form className="d-flex align-items-center justify-content-center">
              <input type="text" className="form-control w-50 border-0 rounded bg-light text-white bg-opacity-25" placeholder="code" required defaultValue="CODE123" />
              <button type="button" data-toast data-toast-text="Your Promo Code Apply Successfully" data-toast-gravity="top" data-toast-position="center" data-toast-classname="success" data-toast-duration={3000} className="btn btn-light ms-2 rounded-2">
                Apply
              </button>
            </form>
          </div>
      ...
      <div className="position-absolute top-100 start-100 translate-middle z-n1 opacity-75">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 800" width={400} height={400}>
          <defs>
