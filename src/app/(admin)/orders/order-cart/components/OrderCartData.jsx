...
const OrderCard = ({
  ...
  return <Card className="cart-detail">
      <CardBody>
        <Row className="gy-3">
          <Col sm={'auto'}>
            <div className="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
              {product?.image && <img src={product?.image} alt="product" className="avatar-lg" />}
            </div>
          </Col>
        ...
        <Row className="g-3">
          <div className="col-sm">
            <div className="d-flex gap-3">
              <Link to="" className="text-dark fs-14 d-flex align-items-center gap-1">
                <IconifyIcon icon="solar:trash-bin-minimalistic-bold-duotone" className="fs-18" /> Remove
              </Link>
              <Link to="" className="text-dark fs-14 d-flex align-items-center gap-1 ms-3">
...
const OrderCartData = () => {
  ...
  return <Col lg={8}>
      <div className="d-flex mb-4 bg-primary p-3 rounded">
        ...
        <Link to="" className="ms-auto text-white fs-14 text-decoration-underline">
          Clear cart
        </Link>
      </div>
