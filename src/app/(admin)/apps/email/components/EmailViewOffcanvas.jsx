  ...
  return <Offcanvas show={open} onHide={toggle} placement="end" className="email-offcanvas w-50">
        ...
        <div className="px-3">
          <div className="mt-2">
            ...
            <div className="d-flex mb-4 mt-1">
              {mail?.from?.image && <img className="me-2 rounded-circle avatar-sm" src={mail.from.image} alt={mail.from.name + '-avatar'} />}
      ...
      <div className="p-3">
        <div className="d-flex">
          {mail?.to?.image && <img className="me-2 rounded-circle avatar-sm" src={mail.to.image} alt={mail.to.name + 'avatar'} />}
          <div className="flex-grow-1">
            <div className="mb-5">
