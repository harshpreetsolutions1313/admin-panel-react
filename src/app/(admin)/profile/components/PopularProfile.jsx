  ...
  return <Card>
      <CardBody>
        <div className="d-flex align-items-center gap-2">
          <img width={56} height={56} src={avatar1} alt="avatar" className="avatar-md rounded-circle border border-light border-3" />
          <div>
            <h4 className="mb-1">
              {name} ,{' '}
      ...
      <CardFooter className="border-top">
        <Row>
          <Col lg={2} xs={4}>
            <Link to="" className="text-primary d-inline-flex gap-1 align-items-center fs-14">
              <IconifyIcon icon="solar:pen-new-square-broken" className="fs-16" /> Answer
            </Link>
          </Col>
          <Col lg={2} xs={4}>
            <Link to="" className="text-dark d-inline-flex gap-1 align-items-center fs-14">
