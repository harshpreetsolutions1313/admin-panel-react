  ...
  return <Card className="overflow-hidden">
      <CardBody>
        <div className="bg-primary profile-bg rounded-top p-5 position-relative mx-n3 mt-n3">
          <img src={avatar2} alt="avatar" className="avatar-lg border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5" />
        </div>
      ...
      <CardFooter className="border-top gap-1 hstack">
        ...
        <Link to="" className="btn btn-soft-dark d-inline-flex align-items-center justify-content-center rounded avatar-sm">
          {' '}
          <span>
...
const CustomerDetailPage = () => {
  const transactionHistoryData = useFetchData(getAllOrders);
  return <>
            ...
            <Col lg={6}>
              <Card>
                <CardBody className=" text-center">
                  <img src={userProfile} alt="use-profile" className="img-fluid" />
                  <h4>
